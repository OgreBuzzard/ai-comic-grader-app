...
//     Rationale for the reset rule: re-shooting the same cover under the same
//     blacklight cannot produce a different answer, so a re-check only makes
//     sense if the BOOK changed - which means work was done on it, which means
//     a fresh paid grade.
...
export const ROBOGRADE_VERSION = '5.20';
