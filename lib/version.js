...
//     Seven of the eight images were already examined by Main/Deep/Full, which
//     flag restoration themselves at no charge. What no other pass can see is
//     COLOR TOUCH - added ink that only fluoresces differently under a
//     blacklight - so that is the whole remaining job: UV Front + UV Back, a
//     short prompt, one question. No credit is charged and none is gated.
...
export const ROBOGRADE_VERSION = '5.18';
