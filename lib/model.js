...
// ── A/B ROUND 2, 2026-09-26: Opus 5.5 at effort 'medium' ────────────────────
//
// Round 1 (both models at MAIN_EFFORT 'low', frozen 1200px set, 12 books x 3):
//
//              mean d    sd    within +-0.5   mean spread   max spread   defects
//   Opus 5      +0.13   0.96      4/10           0.25          0.50        7.48
//   Opus 5.5    +0.76   0.62      3/10           0.52          2.00        5.86
//
// Paired, 5.5 grades +0.63 higher (t = 2.90, 9 df, p ~ 0.018). The defect-list
// diff (claude/OPUS_55_DEFECT_DIFF_2026-09-25.md) showed WHY: severity judgement
// on shared defects is identical (-0.12 on a 1-3 scale), but 5.5 REPORTS FEWER
// DEFECTS, and corr(defect severity load, grade) = -0.967. It grades what it
// sees; it just sees less.
//
// Which makes MAIN_EFFORT the thing to test. It is 'low' only because Opus 4.6
// (May 2026) thought so hard at 'medium' that calls neared the 50s timeout. That
// throttle has ridden along through 4.8 -> 5 -> 5.5 unexamined, and 'low' is an
// instruction each model reads for itself.
//
// TO ROLL BACK IN A HURRY: PRIMARY_MODEL = 'claude-opus-5', MAIN_EFFORT = 'low'.
export const PRIMARY_MODEL = 'claude-opus-5-5';      // $4/$20
// export const PRIMARY_MODEL = 'claude-opus-5';     // $5/$25 - the known-good

// Effort for the MAIN pass (api/assess.js). Deep is separately set to 'medium'
// in api/assess_deep.js and is not part of this test. Raising this raises cost
// and latency for every live assessment, so change it deliberately.
export const MAIN_EFFORT = 'medium';                 // was 'low' since May 2026
