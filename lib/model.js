...
// A/B IN PROGRESS 2026-09-25 (evening). Re-enabled for a second Opus 5.5
// calibration round, this time on the frozen 1200px camera-original set rather
// than the 900px stored images every earlier round used.
//
// What the earlier rounds actually showed, with SE ~= 0.30 on n = 10:
//   v4.57  Opus 5     +0.15   900px
//   v5.25  Opus 5.5   +0.95   900px   <- ~2.3 SE above; the only real difference
//   v5.25  Opus 5     +0.40   900px
//   v5.25  Opus 5     +0.13   1200px  <- current parity baseline
//
// So the 5.5 gap is real and needs re-measuring at parity before any tuning.
// TO ROLL BACK: swap the two lines below. Nothing else changes - every endpoint
// reads PRIMARY_MODEL from here.
export const PRIMARY_MODEL = 'claude-opus-5-5';      // $4/$20, cache reads 0.05x
// export const PRIMARY_MODEL = 'claude-opus-5';     // $5/$25 - the rollback target
