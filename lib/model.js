...
//
// *** TEMPORARILY 'medium' FOR THE 2026-09-26 OPUS 5 EFFORT TEST. ***
// Put this back to 'low' as soon as that round finishes. This raises cost and
// latency for every live assessment, and on Opus 5.5 it also cost 0.49 grades
// of accuracy. The test asks whether Opus 5 degrades the same way: if it does,
// the caution language in the prompt is over-tuned for any model that thinks,
// and 'low' has been accidentally correct since May.
export const MAIN_EFFORT = 'medium';   // REVERT TO 'low' AFTER THE ROUND
