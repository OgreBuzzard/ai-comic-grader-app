...
(function (root) {
  ...
  function scoreBox(o) {
    ...
    var numHtml = '<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;pointer-events:none">'
      + '<span style="font-family:\'Noto Sans Display\',system-ui,sans-serif;font-stretch:62.5%;font-weight:900;color:' + numColor + ';line-height:1;font-size:' + numSize + 'px">' + p.whole + p.frac + '</span></div>';
    // Stars: top-center.
