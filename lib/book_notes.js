...
const NOTES = [
  {
    ...
    note: 'PROMINENT VERTICAL LINE on the front cover: a vertical line runs from the logo area down through the figure to the lower cover, roughly 7 inches, and it very often reads as a full-height vertical crease or a color-breaking (CB) crease. It is PRINTED COVER ARTWORK (the vertical motion/smoke line of the composition), present on every copy of this printing. Do NOT record it as a crease, color-breaking crease, vertical fold, spine defect, or any condition flaw. It is intrinsic to the art, not damage.'
  },
  {
  ...
  },
  {
    ...
    issue: '88',
    appliesTo: ['main', 'deep'],
    note: 'This is a Todd McFarlane cover — a very dense, high-detail ink style with many fine lines, hatching, dark blotchy fields, and irregular textures that are ALL printed artwork. On this book the art is repeatedly misread as damage. Specifically, do NOT record any of the following, which are intrinsic to the printed art, not condition defects: (1) a "crease" through the logo / upper third of the front cover; (2) "soiling" across the front-cover edges and margins; (3) "stains" or brown blotches on the back cover (left side / lower half); (4) "writing" (e.g. a pencil name) in the lower-right of the back cover; (5) a "spine roll." None of these are damage on this cover. Assess only genuine, unambiguous physical defects.'
  },
  {
    title: 'Halloween III',
    issue: '1',
    appliesTo: ['main', 'deep'],
    note: 'A creator signature at the bottom-center of the front cover, accompanied by a seal, is PRINTED as part of the cover artwork. Do NOT read it as owner writing, an added signature, ink, or a defect, and do NOT record it as a Creator signature. It is printed art, present on every copy.'
  },
  {
    title: 'Marvel Super Heroes Secret Wars',
    issue: '8',
    seriesLabel: 'Marvel Super Heroes Secret Wars #8 (1984)',
    appliesTo: ['main', 'deep'],
    note: 'A small dark spot in the LOWER-CENTER of the front cover (~2mm) that looks like a stain, dark spot, or cleaning candidate is PRINTED ARTWORK — it is a wrecking ball held by one of the characters. Do NOT read it as a stain, spot, soiling, or any surface defect, and do NOT flag it as a cleaning/pressing candidate. It is intrinsic to the art, not damage.'
  },
  {
    title: 'Marvel Super Heroes Secret Wars',
    issue: '1',
    seriesLabel: 'Marvel Super Heroes Secret Wars #1 (1984)',
    appliesTo: ['main', 'deep'],
    note: 'An apparent ~1 inch crease at the BOTTOM-RIGHT corner of the front cover is PRINTED ARTWORK — it is the claws of Wolverine. Do NOT read it as a crease, color-breaking crease, or corner defect. It is intrinsic to the art, not damage.'
  },
  {
    title: 'Crisis on Infinite Earths',
    issue: '5',
    seriesLabel: 'Crisis on Infinite Earths #5 (1985)',
    appliesTo: ['main', 'deep'],
    note: 'A VERTICAL line right of center on the front cover, running the full height of the cover (~10 inches) and often reading as color-breaking, is PRINTED ARTWORK. Do NOT read it as a crease, color-breaking crease, vertical fold, or spine defect. It is intrinsic to the art, not damage.'
  },
  {
    title: 'Trees',
    issue: '1',
    seriesLabel: 'Trees #1 (Image, 2014)',
    appliesTo: ['main', 'deep'],
    note: 'A DIAGONAL line in the UPPER-RIGHT quadrant of the BACK cover (~4 inches, often reading as color-breaking) is PRINTED ARTWORK. Do NOT read it as a crease, color-breaking crease, or fold. It is intrinsic to the art, not damage.'
  },
  {
    title: 'Teenage Mutant Ninja Turtles',
    issue: '20',
    yearRange: [2018, 2020],
    seriesLabel: 'Teenage Mutant Ninja Turtles #20 (2019)',
    appliesTo: ['main', 'deep'],
    note: 'A pinpoint speck in the UPPER YELLOW field near the top edge of the front cover (under 1/16 inch, may look like an ink dot or a handling speck) is PRINTED ARTWORK. Do NOT read it as ink, a speck, a spot, or any surface defect. It is intrinsic to the art, not damage.'
  }
];
