...
// ---- CARD v3 ----
t("card full-clean main caps 9.0", RS.computeCard({surface50:50,corners20:20,edges20:20,centering10:10,depth:"main",photograder:A}).grade, 9.0);
...
t("card main shave surface first", RS.computeCard({surface50:50,corners20:20,edges20:20,centering10:10,depth:"main",photograder:A}).subscores, {surface:4.5,corners:1.5,edges:2,centering:1});
...
t("card forCard main default", RS.forCard({cardData:{robograde:{surface:{total:50},corners:{total:20},edges:{total:20},centering:{total:10}}},photograder:A}).grade, 9.0);
