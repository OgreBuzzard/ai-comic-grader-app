...
**Reference-image captions.** Each grade below carries a `Ref-image caption [<file>.jpg]` line — the per-grade condition note lifted from that grade's reference page (the text that used to sit under the image). At assessment time the Deep flow slices the grade's definition plus this caption and places them as a text label immediately before that grade's reference image, so the caption stays bound to the image it describes. Paste each grade's caption into its slot as you crop the images. Combined sections (e.g. 4.5 / 4.0) get one slot per image.

---

## 10.0 — GEM MINT
**Ref-image caption [`10_0.jpg`]:** Razor sharp corners. Perfect spine with no stress lines. No evidence of an ink smear, miswrap or faded colors.
...
## 9.9 — MINT
**Ref-image caption [`9_9.jpg`]:** Near perfect; very slight wear top and bottom spine corners and one small color breaking stress line mid spine.
...
## 9.8 — NEAR MINT / MINT
**Ref-image caption [`9_8.jpg`]:** Two very small color breaking stress lines. Very slight wear beginning to show at corner tips.
...
## 9.6 — NEAR MINT+
**Ref-image caption [`9_6.jpg`]:** Three to four small color breaking stress lines. Slight wear top right corner and top spine.
...
## 9.4 — NEAR MINT
**Ref-image caption [`9_4.jpg`]:** Light spine wear that breaks color. Corners sharp with no other wear present. No printer ink smudge present.
...
## 9.2 — NEAR MINT-
**Ref-image caption [`9_2.jpg`]:** Several color breaking stress lines present, but small in nature. Light wear to corners.
...
**Ref-image caption [`9_0.jpg`]:** Light wear to bottom spine and top right corner. Color breaking spine wear. Light printer ink smudge upper spine.
...
## 8.5 — VERY FINE+
**Ref-image caption [`8_5.jpg`]:** Color breaking wear top corners. Color breaking stress lines. Printer ink smudge present near spine.
...
## 8.0 — VERY FINE
**Ref-image caption [`8_0.jpg`]:** Small color breaking creases top right corner and mid spine. Color breaking stress lines.
...
## 7.5 — VERY FINE-
**Ref-image caption [`7_5.jpg`]:** Crease top right corner. Significant wear bottom spine. Significant stress lines extending out from spine.
...
## 7.0 — FINE / VERY FINE
**Ref-image caption [`7_0.jpg`]:** Reader's crease breaks color along spine. Color breaking finger creases and small tears middle right edge.
...
## 6.5 — FINE+
**Ref-image caption [`6_5.jpg`]:** Light wear to edges of cover. Color breaking creases and stress lines along spine. Color loss right edge.

Significant accumulation of wear. Some structural defects begin to appear.

## 6.0 — FINE
**Ref-image caption [`6_0.jpg`]:** Moderate creasing along spine and right edge. Light tears.

Multiple defects: longer tears, soiling, fading. Missing inserts possible. Tape may be present.

## 5.5 — FINE-
**Ref-image caption [`5_5.jpg`]:** Scuffing and creasing to edges of cover. Moderate stress lines. Minor staple tears.

Substantial wear. Cover gloss significantly reduced.

## 5.0 — VERY GOOD / FINE
**Ref-image caption [`5_0.jpg`]:** Multiple color breaking creases and tears to edges and corners of cover. Heavy wear mid spine.

Moderate-to-substantial defect accumulation.

## 4.5 / 4.0 — VERY GOOD+ / VERY GOOD
**Ref-image caption [`4_5.jpg`]:** Moderate crease right edge. Moderate color breaking wear to spine and edges.
**Ref-image caption [`4_0.jpg`]:** Multiple reader creases break color full length of spine. Creasing bottom right corner.
...
**Ref-image caption [`3_5.jpg`]:** Moderate scuffing and creasing to edges and corners. Heavy color breaking wear spine.
**Ref-image caption [`3_0.jpg`]:** Heavy creasing to mid spine and middle right edge. Large diagonal crease bottom cover.
...
## 2.5 — GOOD+
**Ref-image caption [`2_5.jpg`]:** Cover nearly detached from staples. Heavy color breaking wear top edge. Piece out bottom spine.
...
## 2.0 — GOOD
**Ref-image caption [`2_0.jpg`]:** Moderate tear and split top spine. Heavy color breaking creasing throughout cover.
...
## 1.8 — GOOD-
**Ref-image caption [`1_8.jpg`]:** Cover detached. Heavy creasing, scuffing and tears to cover.
...
## 1.5 — FAIR / GOOD
**Ref-image caption [`1_5.jpg`]:** Moderate piece out of bottom cover. Creasing, tears and small pieces out of edges and spine of cover.
...
## 1.0 — FAIR
**Ref-image caption [`1_0.jpg`]:** Large piece out bottom right corner of front cover.
